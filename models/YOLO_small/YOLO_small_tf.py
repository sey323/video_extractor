...
class YOLO_TF(object):
    ...
    def __init__(self, weights_file="./models/YOLO_small/YOLO_small.ckpt"):
    ...
    def pooling_layer(self, idx, inputs, size, stride):
        if self.disp_console:
            print(
                "    Layer  %d : Type = Pool, Size = %d * %d, Stride = %d"
    ...
    def detect_from_file(self, fromfile, tofile_img, tofile_txt):
        self.fromfile = fromfile
        self.tofile_img = tofile_img
        self.tofile_txt = tofile_txt

        if self.disp_console:
            print("Detect from " + fromfile)
